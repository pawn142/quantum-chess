...
console.log(logic.isMoveLegal({ move: { start: { x: 5, y: 4 }, end: { x: 5, y: 5 } }, declarations: new Set(["nonLeaping", "noCapture"]) }, logic.getResultOfMove({ pushedPawn: { x: 6, y: 7 } }, logic.getResultOfMove({ pushedPawn: { x: 5, y: 2 }}, piece.defaultPosition))));
